...
### 2. ch5/5.4.3 블루그린 파이프라인 실기 검증 ⏳ 미수행

kustomize 이미지 자체는 arm64 파드에서 명령 5개까지 확인했으나,
**젠킨스 파이프라인 전체(1차 blue / 2차 green)는 아직 안 돌려봤다.**
젠킨스를 세우지 않았기 때문이다(ch5 5.2.3 헬름 -> 5.3.1 설치 -> 5.3.4 SA 권한 필요).

관련: [bluegreen-pipeline.md](bluegreen-pipeline.md)
