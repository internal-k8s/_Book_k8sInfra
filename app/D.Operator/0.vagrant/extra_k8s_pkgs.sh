...
# Setup loadbalancer
kubectl apply -f $HOME/_Book_k8sInfra/app/D.Operator/0.vagrant/extra-k8s-packages/cilium-l2announcement-policy.yaml
kubectl apply -f $HOME/_Book_k8sInfra/app/D.Operator/0.vagrant/extra-k8s-packages/cilium-loadbalancer-ip-pool.yaml