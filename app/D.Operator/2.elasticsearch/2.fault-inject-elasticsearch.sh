...
kubectl get statefulset -l elasticsearch.k8s.elastic.co/cluster-name=elasticsearch
echo "===================================================="
echo "현재 엘라스틱서치 파드 상태"
kubectl get pods -l elasticsearch.k8s.elastic.co/cluster-name=elasticsearch
echo "===================================================="
echo "결함 주입: 스테이트풀셋 삭제"
kubectl delete statefulset -l elasticsearch.k8s.elastic.co/cluster-name=elasticsearch
sleep 10
echo "===================================================="
echo "현재 엘라스틱서치 커스텀 리소스 상태"
kubectl get elasticsearch elasticsearch
...
kubectl get pvc -l elasticsearch.k8s.elastic.co/cluster-name=elasticsearch
echo "===================================================="
echo "현재 엘라스틱서치 파드 상태"
kubectl get pods -l elasticsearch.k8s.elastic.co/cluster-name=elasticsearch
echo "엘라스틱서치가 사용 가능할 때 까지 대기"
while [[ $(kubectl get elasticsearch elasticsearch -n default -o jsonpath='{.status.phase}') != "Ready" ]]; do
